...
<h1> ReFu - Regulatory Functions panel</h1>
...
<fieldset>
<form action="">
 <label for=”grav”>Newgravatar:</label> <input type="text" name="gravatar" id="grav"  size="40"  value="abr4xas"  tabindex="1" /><br>
   <label for=”rss”>Custom feed link:</label> <input type="text" name="feed" id="rss" size="40"  value="feeds.feedburner.com/ElBlogDeAbr4xasVol2"  tabindex="2" /><br>
 <label for=”fadmin”>Foter text admin panel:</label> <input type="text" name="footer" id="fadmin" size="40"  value="With wordpress and love <3" tabindex="3" /><br>
